...
from flowvae.base_model import convEncoder, convDecoder
...
if __name__ == '__main__':
    ...
    for run in range(0,3):
        ...
        # define the model
        vae_model = frameVAE(latent_dim=latent_dim, encoder=_dec, decoder=_dec, decoder_input_layer=1, code_mode=code_mode, device=device)
        ...
        op = AEOperator('0628_%d_Run%d' % (run_no, run), vae_model, fldata, init_lr=0.0001, num_epochs=300, batch_size=16, ref=ref, output_folder='.')    
